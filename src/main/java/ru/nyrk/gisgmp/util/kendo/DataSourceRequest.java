package ru.nyrk.gisgmp.util.kendo;
...
public class DataSourceRequest {
    ...
    private static void restrict(Junction junction, FilterDescriptor filter, Class<?> clazz) {
        ...
        else if (operator.equals("qt")) {
            junction.add(Restrictions.gt(field, value));
        } else if (operator.equals("qte")) {
    ...
    public void setSortField(String fieldNm) {
        List<SortDescriptor> srt = new ArrayList<SortDescriptor>();
        srt.add(new SortDescriptor());
        srt.get(0).setField(fieldNm);
        srt.get(0).setDir("asc");
        setSort(srt);
    }
    ...
    public static class FilterDescriptor {
        ...
        public FilterDescriptor(String field, Object value) {
            this();
            this.field = field;
            this.value = value;
        }
